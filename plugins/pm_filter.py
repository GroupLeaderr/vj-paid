...
async def pm_text(bot, message):
        ...
        try:
            ...
            if not link:
                ...
                if PM_SEARCH == True:
                    ...
                    await message.reply_text(text=f"<b>Nᴀᴍᴀsᴛʜᴇ {user} Jɪ 😍 , \n\nɪ ᴄᴀɴᴛ ɢɪᴠᴇ ᴍᴏᴠɪᴇ ʜᴇʀᴇ\nɪ ᴡᴏʀᴋ ᴏɴʟʏ ɪɴ ɢʀᴏᴜᴘs</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("👉 Request Here 👈", url='https://t.me/+E0x9VQvJ2bMwNjM9')]]))
    ...
    if PM_SEARCH == True:
        ...
        await message.reply_text(text=f"<b>Nᴀᴍᴀsᴛʜᴇ {user} Jɪ 😍 , \n\nɪ ᴄᴀɴᴛ ɢɪᴠᴇ ᴍᴏᴠɪᴇ ʜᴇʀᴇ\nɪ ᴡᴏʀᴋ ᴏɴʟʏ ɪɴ ɢʀᴏᴜᴘs</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ 😊", url='https://t.me/+x_XLFOhgjSMyZWZl')]]))
        await bot.send_message(chat_id=LOG_CHANNEL, text=f"<b>#𝐏𝐌_𝐌𝐒𝐆\n\nNᴀᴍᴇ : {user}\n\nID : {user_id}\n\nMᴇssᴀɢᴇ : {content}</b>")
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        btn = [[            
            InlineKeyboardButton("✅sᴇɴᴅ ʏᴏᴜʀ ᴘᴀʏᴍᴇɴᴛ ʀᴇᴄᴇɪᴘᴛ ʜᴇʀᴇ✅", user_id=int(5355635400))
        ]
            for admin in ADMINS
        ]
        btn.append(
    ...
    if query.data.startswith("file"):
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("I Like Your Smartness, But Don't Be A Oversmart 😒", show_alert=True)
            return
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/+KfRHEjSu3Dk2ZmJl")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
            InlineKeyboardButton('❄️ 𝐑𝐞𝐪 𝐆𝐫𝐨𝐮𝐩 🥀', url=GRP_LNK),
            InlineKeyboardButton('💀 𝐒𝐨𝐮𝐫𝐜𝐞 𝐂𝐨𝐝𝐞 💀', callback_data='source')
        ],[
            InlineKeyboardButton('⭐️𝐇𝐨𝐦𝐞⭐️', callback_data='start'),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="https://t.me/GroupLeaderr")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
