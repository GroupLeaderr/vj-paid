...
PICS = (environ.get('PICS', 'https://graph.org/file/cd16a80421a63c71c00a5.mp4')).split() #SAMPLE PIC
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002009301289') # give your force subscribe channel id here else leave it blank
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://autofilter10-c15fbe36ddab.herokuapp.com/")
